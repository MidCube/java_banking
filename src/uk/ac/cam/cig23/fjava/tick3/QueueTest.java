...
public class QueueTest {
  ...
  //join makes this run thread wait until the thread we called
  //it on terminates. Also returns if the thread was interupted
  //or if it has already terminated/not started.
  public void run() {
